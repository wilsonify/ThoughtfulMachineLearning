...
# + [markdown] _cell_guid="e3bc4854-2787-eae1-950d-2742ad3d7db2" _uuid="d507f816cc74a88c9afefd02cf225d1a7dd6461f"
...
# + [markdown] _cell_guid="8ca352d7-08aa-36b4-fb2d-3c9854a8d86a" _uuid="014f5c099a26d9232f9d0d6ca85d5c02b812c98a"
...
# + _cell_guid="2df621e0-e03c-7aaa-6e08-40ed1d7dfecc" _execution_state="idle" _uuid="d581f6797b9fde1580271358d484df67bf6b14a1"
...
# + _cell_guid="d56d5e71-4277-7a74-5306-7d5af4c7f263" _execution_state="idle" _uuid="827a72128cd211cf6af16b003e7c09951e3f2b1e"
#bring in the six packs
df_train = pd.read_csv('../input/train.csv')

# + _cell_guid="02250c81-7e15-c195-2e86-5adbd15c9d30" _execution_state="idle" _uuid="10814ba44786b5fea5e333324c6fe54729cabf33"
#check the decoration
df_train.columns

# + [markdown] _cell_guid="79d22981-dfd7-a25f-9a78-5436213207e2" _uuid="ba13c267e3aacbef23dfbcc0ab05f002d7835e0c"
...
# + [markdown] _cell_guid="3ef87d93-0ea6-8cb2-aa2d-90d5b56a1ca1" _uuid="39d104c7e40b3f66a0f6e2330119332b301be7bf"
...
# + _cell_guid="54452e23-f4d3-919f-c734-80a35dc9ae08" _execution_state="idle" _uuid="5c15e1bd10b8e71c0b1d62bdb260882585a35579"
#descriptive statistics summary
df_train['SalePrice'].describe()

# + [markdown] _cell_guid="6af460e5-1be2-6618-d624-2a4423bd501f" _uuid="bb3005e8025ea75b0b4d1ef624927e7e21833ea1"
...
# + _cell_guid="6bbea362-77b6-5385-f0a8-fb53afd088b7" _execution_state="idle" _uuid="2f78c77caa7290298138caf167672e62d3bc5a67"

#histogram
sns.distplot(df_train['SalePrice']);

# + [markdown] _cell_guid="f4e257f0-1dfd-0774-b346-f2a1b2a068cc" _uuid="f84e60c8b934615e53af10823558fe42753ac25d"
...
# + _cell_guid="36766737-f1a3-fe40-dbec-63c31be4d5e0" _execution_state="idle" _uuid="2cb253768dcd75b9a450ee264626ce69c808096a"
#skewness and kurtosis
print("Skewness: %f" % df_train['SalePrice'].skew())
print("Kurtosis: %f" % df_train['SalePrice'].kurt())

# + [markdown] _cell_guid="7a3e43cc-5b75-0b49-1ad2-426d10d7fb42" _uuid="c984e32d4d10b1e6766c1b79ed8ade9a57529ffb"
...
# + [markdown] _cell_guid="c477edc1-b472-f55b-ba98-514159dbda2e" _uuid="e0368771327b15853b3e306f39eb93d209594e75"
# # 'SalePrice', her buddies and her interests

# + [markdown] _cell_guid="b02d4be5-ef2c-bd5c-ff71-2c790b3637ce" _uuid="c6edbfb50a21f4c94052f86f6926cfdc35e7ca22"
...
# + [markdown] _cell_guid="73c1a953-aafd-96f6-c7bd-e2c79b3e5a0b" _uuid="08e034d70ed14ef0c4fb8cc1e9dd9e15f0d1c996"
# ### Relationship with numerical variables

# + _cell_guid="db040973-0adc-e126-e657-1d8934b5a5c8" _execution_state="idle" _uuid="91160363898f5caeee965a1aa81eb3abb7dcd760"
#scatter plot grlivarea/saleprice
var = 'GrLivArea'
data = pd.concat([df_train['SalePrice'], df_train[var]], axis=1)
data.plot.scatter(x=var, y='SalePrice', ylim=(0,800000));

# + [markdown] _cell_guid="c3dccb06-206a-20c0-6060-8d5b49f4df0b" _uuid="6775955416e9b2d4ac43e3fec5685c8577138455"
...
# + _cell_guid="353def35-0f26-998d-b9a4-7356f95e80ad" _execution_state="idle" _uuid="3ac3db51311338fcdc16014a7c506cf3d5315af7"
#scatter plot totalbsmtsf/saleprice
var = 'TotalBsmtSF'
data = pd.concat([df_train['SalePrice'], df_train[var]], axis=1)
data.plot.scatter(x=var, y='SalePrice', ylim=(0,800000));

# + [markdown] _cell_guid="7ea69b90-de6d-c104-ff92-a49943993930" _uuid="4496c7d3635636e8e19296f3b5b52fdba16f7cc5"
...
# + [markdown] _cell_guid="b31bc890-46bf-618c-e668-17879763ad23" _uuid="5550d4df3c0ad48d8b2b9b0905f17daa3fc8d244"
# ### Relationship with categorical features

# + _cell_guid="26d0fddc-cb09-af7d-9f03-a07233fa6c9e" _execution_state="idle" _uuid="e2b7aaccc3486a74a09996289a833ffb6acd0764"
...
# + [markdown] _cell_guid="49c33fb5-fce0-e852-7f31-2d0da20f7b16" _uuid="463ae72c67dfa50524f9b2c89427dbcd4b7bd856"
...
# + _cell_guid="590da500-3e48-7059-4f0b-1ef1801dd1db" _execution_state="idle" _uuid="a78c64aeed1e48aa453ae4b7deef172cb2060b39"
var = 'YearBuilt'
data = pd.concat([df_train['SalePrice'], df_train[var]], axis=1)
...
# + [markdown] _cell_guid="ad19b4d2-cb40-2e10-c6ee-913a0d5a6618" _uuid="22f458a1252d0eed8bbd6f0d0b56508033e228bd"
...
# + [markdown] _cell_guid="9d2f4940-ee0c-edef-769d-65fead4f06f3" _uuid="1dc93d788b3cd2446afa41e7c06d05c6bbadb480"
# ### In summary
#
...
# + [markdown] _cell_guid="b75e5f62-307b-f5f4-79ac-38815a7a6da4" _uuid="aa4ed71a6d1003513b4e31adacd0e7a491671f0f"
# # 3. Keep calm and work smart

# + [markdown] _cell_guid="2ea2f896-48a6-db39-0684-6a029d8fda60" _uuid="d67e5bf6f2c4b6acb617c4cdcee0dc5c3f79d9b8"
...
# + [markdown] _cell_guid="0eb27879-4f54-6fd7-e07a-156eae1aef7f" _uuid="4816779faf59b3eebf954c36bb3c85ff7dfc87a9"
# ### The 'plasma soup'
#
...
# + [markdown] _cell_guid="06f8d02c-d779-f8fd-7f48-ba3c5166eda8" _uuid="bf469f1030a8768f73a18e5ad59db43c4241c603"
# #### Correlation matrix (heatmap style)

# + _cell_guid="4eb7a6ef-adf5-6abf-947d-c95afdc477b8" _execution_state="idle" _uuid="5dfee22210f5a126ea34ca6475bb4f365d41317b"
#correlation matrix
corrmat = df_train.corr()
f, ax = plt.subplots(figsize=(12, 9))
sns.heatmap(corrmat, vmax=.8, square=True);

# + [markdown] _cell_guid="977fb7af-70e1-bfb8-e381-3176ec0321b0" _uuid="b6eb357b201b4d2a9e81f4373cadb9aeccc2482c"
...
# + [markdown] _cell_guid="9b557956-df91-bab3-0e8b-d8ffc054470f" _uuid="6ef7d7b7747807431aa9827046c76bfa3d34ffe1"
# #### 'SalePrice' correlation matrix (zoomed heatmap style)

# + _cell_guid="bc33db9e-9ee3-6cfe-7643-a2aff5a9234d" _execution_state="idle" _uuid="a6ee47c540ce9f3f1d2af6efe0b030e76e3a3f7f"
...
# + [markdown] _cell_guid="f5c23b8a-aad9-809f-0fdf-f758f926f5c9" _uuid="c10a0a0bd55e55822726c78a59ab2bb6d9763f68"
...
# + [markdown] _cell_guid="3bdb34db-cf47-d8c8-b857-7031828808ed" _uuid="28e0b3f8ecee68390a40bd653d7370c20615ad5d"
# #### Scatter plots between 'SalePrice' and correlated variables (move like Jagger style)

# + [markdown] _cell_guid="f49b1a3a-2edf-d582-e4ed-3b6188675fbc" _uuid="cbebb4763aa2a977078a1fba424073b3ea1ecd61"
...
# + _cell_guid="5a8db5de-d3f9-9a28-f220-bb05d51c53d0" _execution_state="idle" _uuid="cdafd230216fd04cc4ecf635967925da0bce9195"
#scatterplot
sns.set()
...
# + [markdown] _cell_guid="a61d0a23-e5e4-3190-41a7-03a5110dc967" _uuid="7dd622e414e1fda79d2d1f163b1d30d6c2de15eb"
...
# + [markdown] _cell_guid="9ce00498-d5e6-9e35-debc-8d507002d461" _uuid="726efbb348d1022cabb171f622d7b4e01fe8c778"
# # 4. Missing data
#
...
# + _cell_guid="ca2f89e7-1c16-c3ae-6fe0-ab4eaf7e52a1" _execution_state="idle" _uuid="664e03dc1434fa2c4eb730ea36ab60e37f13cd3f"
#missing data
...
# + [markdown] _cell_guid="42bf6c61-9836-5c25-ff2f-1219e96f60a2" _uuid="c7607aaf8378eac11a8a8395dcd4a2346c22f5ea"
...
# + _cell_guid="f43f72c5-5457-1f47-e8ef-502db4355086" _execution_state="idle" _uuid="726617e295ee6bfe26ccf277323cc68ef52dc61b"
#dealing with missing data
df_train = df_train.drop((missing_data[missing_data['Total'] > 1]).index,1)
df_train = df_train.drop(df_train.loc[df_train['Electrical'].isnull()].index)
df_train.isnull().sum().max() #just checking that there's no missing data missing...

# + [markdown] _cell_guid="bf77b1ad-c87b-0be1-7adc-02b0186e2c37" _uuid="402bab0012e6f60f3fd045788d9c60e02e43e46d"
# # Out liars!
#
...
# + [markdown] _cell_guid="06852f05-22e9-6ea3-ae37-c08f83ed401f" _uuid="39ccb28e64249ea88dc9d04c5c1484734a8e9dcc"
# ### Univariate analysis

# + [markdown] _cell_guid="1553bf55-edb3-7c65-f505-227d34d018fb" _uuid="1c4f41a45aabef83aab703c4e9c0101db1d3c7f7"
# The primary concern here is to establish a threshold that defines an observation as an outlier. To do so, we'll standardize the data. In this context, data standardization means converting data values to have mean of 0 and a standard deviation of 1.

# + _cell_guid="49a133fb-b713-45bd-ca42-c1ca0eb4d3f6" _execution_state="idle" _uuid="09b3bc296d01936b3b6df7f3ea670499e926720e"
#standardizing data
...
# + [markdown] _cell_guid="4ae8ecbd-3236-7e32-fa2c-9c12a6ba53d3" _uuid="68d1465ef6f6da48d318868646741072eec73f0b"
...
# + [markdown] _cell_guid="ae1b038a-9016-1412-bfb8-e2a27022a02f" _uuid="6b9511771766dbdb72abe83ec3f479c40c08ce6d"
# ### Bivariate analysis

# + [markdown] _cell_guid="ed741196-bc75-a4b5-dda9-417b6d8aa52b" _uuid="a4137453b99017b08ed6d433829e04160b6613d2"
...
# + _cell_guid="a03b5ee8-0701-10f0-2d4c-06fcaf1fada5" _execution_state="idle" _uuid="4d3e3941ca62ce141f96d0fd2f3276cd80e03ed3"
#bivariate analysis saleprice/grlivarea
var = 'GrLivArea'
data = pd.concat([df_train['SalePrice'], df_train[var]], axis=1)
data.plot.scatter(x=var, y='SalePrice', ylim=(0,800000));

# + [markdown] _cell_guid="48c2ad5c-b861-6b33-a292-9d6b7b58b1cc" _uuid="8ef88aabbea5235f920f0a12eba9cf9f640b5f6d"
# What has been revealed:
#
# * The two values with bigger 'GrLivArea' seem strange and they are not following the crowd. We can speculate why this is happening. Maybe they refer to agricultural area and that could explain the low price. I'm not sure about this but I'm quite confident that these two points are not representative of the typical case. Therefore, we'll define them as outliers and delete them.
# * The two observations in the top of the plot are those 7.something observations that we said we should be careful about. They look like two special cases, however they seem to be following the trend. For that reason, we will keep them.

# + _cell_guid="63a6517c-431f-c3fe-30cf-61034e54a5cb" _execution_state="idle" _uuid="ff34e1e620a89d16ecf35508e40e23b1d7a4771c"
#deleting points
df_train.sort_values(by = 'GrLivArea', ascending = False)[:2]
df_train = df_train.drop(df_train[df_train['Id'] == 1299].index)
df_train = df_train.drop(df_train[df_train['Id'] == 524].index)

# + _cell_guid="1d4bf215-19d5-877e-1958-f5713009a94a" _execution_state="idle" _uuid="a48108966041d652f9fee571bf9ff08a7c73f6ef"
#bivariate analysis saleprice/grlivarea
var = 'TotalBsmtSF'
data = pd.concat([df_train['SalePrice'], df_train[var]], axis=1)
data.plot.scatter(x=var, y='SalePrice', ylim=(0,800000));

# + [markdown] _cell_guid="ff4b9944-30d2-834a-de2f-6ee1b54aefc6" _uuid="83b610acd7caee0f0ac5e82856bbeb17fb54ceee"
...
# + [markdown] _cell_guid="a0b5def9-2709-a643-0ade-2689b6b36dae" _uuid="283f857f9ac2e1510cd238f59d937132a5492da6"
# # 5. Getting hard core

# + [markdown] _cell_guid="1b997f3f-c28f-6029-64c9-2d2bfc01077c" _uuid="f8e75e15ed7cba60c64c44b4fa3ec6737414e218"
...
# + [markdown] _cell_guid="0f1a301d-0c06-548f-540d-124975931e70" _uuid="2497351eca10510469b27ca8518c5c1510932dc1"
# ### In the search for normality

# + [markdown] _cell_guid="0d4f4ca7-3d4f-99e2-2aa7-1a6a6fc9e62e" _uuid="b408f24ef2b8fe26e44243fd7b0931a169789cc1"
...
# + _cell_guid="99ca9885-9335-411e-9b35-21ff69d312e6" _execution_state="idle" _uuid="ad844362305f49c0e199ffe276dd119563d46a72"
#histogram and normal probability plot
sns.distplot(df_train['SalePrice'], fit=norm);
fig = plt.figure()
res = stats.probplot(df_train['SalePrice'], plot=plt)

# + [markdown] _cell_guid="ad84e765-4e47-2f00-dc09-474bf24c1dee" _uuid="eb8588ce1dd5cfcdd62a943268fa7d252ca7c447"
...
# + _cell_guid="cced5b14-c39d-c847-6dc9-93af3f4b6e6d" _execution_state="idle" _uuid="f578838e98e9996b09abbec058200cb18aa38869"
#applying log transformation
df_train['SalePrice'] = np.log(df_train['SalePrice'])

# + _cell_guid="0e17fba2-3ff2-d6f1-841d-bc2a9746bcc2" _execution_state="idle" _uuid="de8366b3ad71c7cb398644766a412bee1d05642f"
#transformed histogram and normal probability plot
sns.distplot(df_train['SalePrice'], fit=norm);
fig = plt.figure()
res = stats.probplot(df_train['SalePrice'], plot=plt)

# + [markdown] _cell_guid="74131161-b766-8b08-5ae3-0b70688a198a" _uuid="19b172dfedfef5330c53cc34837d47641a3cf135"
# Done! Let's check what's going on with 'GrLivArea'.

# + _cell_guid="bda5d77e-07ea-1d16-644c-a850487cc35d" _execution_state="idle" _uuid="aa29a3612ee861c42e5d6022ac3a8ad75266b0ee"
#histogram and normal probability plot
sns.distplot(df_train['GrLivArea'], fit=norm);
fig = plt.figure()
res = stats.probplot(df_train['GrLivArea'], plot=plt)

# + [markdown] _cell_guid="7a8fa54e-46e2-5c09-0a43-0b200ee59874" _uuid="f452585a30fe3006d4dc993941e826c793044a4b"
# Tastes like skewness... *Avada kedavra!*

# + _cell_guid="c0fe3abe-cc32-6f2e-0e79-1afd9b49c7ad" _execution_state="idle" _uuid="aa428f580e39e498dc06747423955fa714d97952"
#data transformation
df_train['GrLivArea'] = np.log(df_train['GrLivArea'])

# + _cell_guid="0171b317-885d-7092-ade9-d2332b8ea796" _execution_state="idle" _uuid="bb004d70d1f260289f864c2ecb5c5dceedc2d6fa"
#transformed histogram and normal probability plot
sns.distplot(df_train['GrLivArea'], fit=norm);
fig = plt.figure()
res = stats.probplot(df_train['GrLivArea'], plot=plt)

# + [markdown] _cell_guid="1686254a-4391-a744-b8ae-653364e216d4" _uuid="bdd45521276779b330af14f279bf578a9457dac0"
# Next, please...

# + _cell_guid="4cec452c-ccfd-e65e-2e8b-6c601d3664cd" _execution_state="idle" _uuid="b9b1528dcb2a5d1a85c469c69f9df08149fe5ff0"
#histogram and normal probability plot
sns.distplot(df_train['TotalBsmtSF'], fit=norm);
fig = plt.figure()
res = stats.probplot(df_train['TotalBsmtSF'], plot=plt)

# + [markdown] _cell_guid="8212aea1-70b8-5cdb-1d54-ebad40f3d73e" _uuid="317120e4f6469692db40bfb8c9c450cf2dc91938"
...
# + _cell_guid="a025f96a-c537-92d5-9187-355cb4f0a520" _execution_state="idle" _uuid="5cb8e327f4fd2e4714ec522bdd64c6ed81781652"
...
# + _cell_guid="9933a45e-93f0-b43f-e7ad-2cb1986570d8" _execution_state="idle" _uuid="a7b15dd8a8163ab753ca2aa9e16ed38616bd2d03"
#transform data
df_train.loc[df_train['HasBsmt']==1,'TotalBsmtSF'] = np.log(df_train['TotalBsmtSF'])

# + _cell_guid="8a2dc1c6-162d-4b42-8687-046b1ca47511" _execution_state="idle" _uuid="f8b1b53558610f9623617fd71a6440439a47e48e"
#histogram and normal probability plot
sns.distplot(df_train[df_train['TotalBsmtSF']>0]['TotalBsmtSF'], fit=norm);
fig = plt.figure()
res = stats.probplot(df_train[df_train['TotalBsmtSF']>0]['TotalBsmtSF'], plot=plt)

# + [markdown] _cell_guid="78c3c8e5-4ddd-e9ba-6ea8-a23b9d2b21a5" _uuid="f6f0988bbc48a298177ecc7ec70f2706c72fc1db"
# ### In the search for writing 'homoscedasticity' right at the first attempt

# + [markdown] _cell_guid="14a0ff01-0d6d-4f3e-c959-0b1039b06439" _uuid="469987c7961cd885cc4233626426777e2b675466"
# The best approach to test homoscedasticity for two metric variables is graphically. Departures from an equal dispersion are shown by such shapes as cones (small dispersion at one side of the graph, large dispersion at the opposite side) or diamonds (a large number of points at the center of the distribution).
#
# Starting by 'SalePrice' and 'GrLivArea'...

# + _cell_guid="a5f13ea7-70af-6a3d-bff1-84a696972e59" _execution_state="busy" _uuid="d6db45dbc22abfcdaf49be23f70e6b8f4ca4c13b"
#scatter plot
plt.scatter(df_train['GrLivArea'], df_train['SalePrice']);

# + [markdown] _cell_guid="522a6dc2-291a-807b-8fe9-3aa335dbd79d" _uuid="aed0d40afac41960d6409e9ea4ff9cd3d484ae86"
# Older versions of this scatter plot (previous to log transformations), had a conic shape (go back and check 'Scatter plots between 'SalePrice' and correlated variables (move like Jagger style)'). As you can see, the current scatter plot doesn't have a conic shape anymore. That's the power of normality! Just by ensuring normality in some variables, we solved the homoscedasticity problem.
#
# Now let's check 'SalePrice' with 'TotalBsmtSF'.

# + _cell_guid="d5a6cecd-4f33-5afe-2c95-9459da03091f" _execution_state="idle" _uuid="45cdf80ae7cf8bf1d5d62ff09f6e9b106047cafb"
#scatter plot
plt.scatter(df_train[df_train['TotalBsmtSF']>0]['TotalBsmtSF'], df_train[df_train['TotalBsmtSF']>0]['SalePrice']);

# + [markdown] _cell_guid="38a2af07-61d9-bc63-e78d-f88fd8bd03dc" _uuid="612394fe6ca03c21a96019cb72bd64966d05066e"
# We can say that, in general, 'SalePrice' exhibit equal levels of variance across the range of 'TotalBsmtSF'. Cool!

# + [markdown] _cell_guid="56d7b15d-aaa1-0aaf-875b-8d914f4983dd" _uuid="9957d2bc81d7c1f694314495b923469be3428bbf"
# # Last but not the least, dummy variables

# + [markdown] _cell_guid="b782af0e-c785-0fbb-de2d-1301b53ba729" _uuid="4603fc4c5a9b54139d7d0b598b5afbad66ad4b2e"
# Easy mode.

# + _cell_guid="06dfd6a2-f613-01e8-b7d0-2672dfd41db8" _execution_state="idle" _uuid="0f697a3a1949c3d9b86e9c38b11628d3f8bdc138"
#convert categorical variable into dummy
df_train = pd.get_dummies(df_train)

# + [markdown] _cell_guid="92018f8f-4782-5a0c-9fee-f657b6331ffd" _uuid="38631001da379277b3ae8cbc78504546a23a810d"
# # Conclusion

# + [markdown] _cell_guid="95c93455-85f4-e0a4-3d3a-8365bcf750e0" _uuid="c05bfefad3b6084b9a7314ab87e5d9ae54af5ba1"
...
# + [markdown] _cell_guid="f29b0f7c-5f02-e28b-fc3b-c161fde831aa" _uuid="69dd52ff366c69a33a1aabe58e9f6718ba7a73b3"
# # <b>References</b>
...
# + [markdown] _cell_guid="2f6375aa-89c3-d6d1-6acb-288eab8b24f5" _uuid="06c7675e062996ed0f706776afacc2138bf5ed63"
# # Acknowledgements
#
